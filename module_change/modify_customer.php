...
$id = $_GET['id'];
$consulta = ("SELECT * FROM cliente WHERE id_cliente='$id' LIMIT 1");
...
<div class="container">
    <div class="col-md-6 col-md-offset-3">
        <form action="request_bd/edit_customer.php" method="post">
            <label for="nombre_cliente" class="espacio-arriba2">Empresa.</label>
            <input type="hidden" class="form-control" name="id" required=""
                   value='<?php echo $id; ?>' id="empresa">
            <input type="text" class="form-control" name="empresa" required=""
                   value='<?php echo $columnas["empresa"]; ?>' id="empresa">
            ...
            <input type="text" class="form-control" name="nombre_cliente" required=""
                   value='<?php echo $columnas["nombre_cliente"]; ?>' id="nombre_cliente">
            ...
            <input type="text" class="form-control" name="apellidos_cliente" required=""
                   value='<?php echo $columnas["apellidos_cliente"]; ?>' id="apellidos_cliente">
            ...
            <input type="email" class="form-control" name="email_cliente"
                   ...
                   value='<?php echo $columnas["email_cliente"]; ?>'>

            <label for="nic_cliente" class="espacio-arriba2">CIF/NIF.</label>
            <input type="text" class="form-control" name="cif_nif"
                   value='<?php echo $columnas["cif_nif"]; ?>' required="" id="nic_cliente">
            <div class="">
                <article>
                    <label for="" class="espacio-arriba2">Seleccione Pais</label>
            ...
            <input value='<?php echo $columnas["ciudad_cliente"]; ?>' type="text" class="form-control"
                   name="ciudad_cliente" required="">

            <label for="estado" class="espacio-arriba2">Provicia.</label>
            <input value='<?php echo $columnas["provicia_cliente"]; ?>' type="text" class="form-control"
                   name="provicia_cliente" required="">

            <label for="estado" class="espacio-arriba2">Código Postal.</label>
            <input value='<?php echo $columnas["codigo_postal"]; ?>' type="text" class="form-control"
            ...
            <textarea class="form-control" name="direccion_cliente" rows="3"
                      required><?php echo $columnas["direccion_cliente"]; ?> </textarea>

            <label for="telefono_movil_cliente" class="espacio-arriba2">Telefono Movil.</label>
            <input value='<?php echo $columnas["telefono_movil_cliente"]; ?>' type="text" class="form-control"
                   name="telefono_movil_cliente" required="">

            <label for="telefono_local_cliente " class="espacio-arriba2">Telefono Local.</label>
            <input value='<?php echo $columnas["telefono_local_cliente"]; ?>' type="text" class="form-control"
                   name="telefono_local_cliente" required="">

            <div class="center-block espacio-arriba inline-block quitar-float">
                <input type="submit" name="enviar" value="Modificar" class="btn btn-default espacio-derecha1"/>
