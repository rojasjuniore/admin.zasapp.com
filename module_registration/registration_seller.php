    ...
    <div class="col-md-6 col-md-offset-3">
        <form action="request_bd/registration_seller.php" method="post">
            <article>
                ...
                <input type="email" class="form-control" name="email_vendedor" rrequired
                       id="Email_vendedor">
                ...
                <label for="omision_vendedor" class="espacio-arriba2">Comision</label>
                <input type="password" class="form-control" name="comision_vendedor"
                       required
